...
# В классе Board измените DISPLAY_MISS:
class Board:
    SIZE = 8
    ...
    DISPLAY_MISS = "⚫"     # черный круг - промах (было ⚪)
...
class Game:
    ...
    # НОВАЯ СХЕМА ФЛОТА: [4, 3, 2, 2, 2, 1, 1, 1] - 8 кораблей
    # 1 корабль 4x1, 1 корабль 3x1, 3 корабля 2x1, 3 корабля 1x1
    FLEET_SCHEME = [4, 3, 2, 2, 2, 1, 1, 1]
